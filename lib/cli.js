  ...
  var commands = {
    ...
    iterate: {
      ...
      options: [
        ...
        { arg: '-b, --batch-size <batchSize>', desc: 'How many documents to save/remove per bulk update | default: 500', action: parseInt },
        { arg: '-p, --page-size <pageSize>', desc: 'How many documents to retrieve per page | default: 10000', action: parseInt },
